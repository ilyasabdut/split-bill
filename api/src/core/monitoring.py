...
class HealthMonitor:
        ...
        try:
            ...
            health_status = {
                ...
                "summary": {
                    "total_services": 4,
                    "healthy_services": 1,
                    "average_response_time_ms": round((time.time() - start_time) * 1000, 2),
    ...
    async def record_request_metrics(self, endpoint: str, response_time: float, status_code: int, error: Optional[str] = None):
