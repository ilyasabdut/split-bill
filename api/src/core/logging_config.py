...
def log_request(logger_instance: logging.Logger, request: Request, response: Response, duration_ms: float):
...
def log_error(logger_instance: logging.Logger, error: Exception, context: Optional[Dict[str, Any]] = None):
...
def log_performance(logger_instance: logging.Logger, operation: str, duration_ms: float, context: Optional[Dict[str, Any]] = None):
...
def log_security_event(logger_instance: logging.Logger, event_type: str, details: Optional[Dict[str, Any]] = None):
    ...
    logger_instance.warning(
        "Security Event - Type: %s, Details: %s",
        event_type,
    ...
    def decorator(func):
        ...
        async def wrapper(*args, **kwargs):
            ...
            try:
                ...
                log_performance(logger, op_name, duration_ms, {
                    "status": "success",
