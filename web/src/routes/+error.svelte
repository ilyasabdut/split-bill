  ...
  <Card class="max-w-md w-full">
    <div class="text-center py-12">
      {#if status === 404}
        ...
        <p class="text-text-secondary mb-8">Sorry, we couldn't find the page you're looking for. It might have been moved or deleted.</p>
        <div class="space-y-3">
      ...
      {:else}
        ...
        <p class="text-text-secondary mb-8">{error.message || 'An unexpected error occurred.'}</p>
        <div class="space-y-3">
