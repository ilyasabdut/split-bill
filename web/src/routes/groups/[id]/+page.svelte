	...
	<main class="flex-1 overflow-y-auto px-4 py-4 space-y-5 max-w-lg mx-auto w-full" style="padding-bottom: calc(env(safe-area-inset-bottom, 0px) + 2rem);">
		...
		<section class="rounded-3xl bg-gradient-to-br from-indigo-500 to-violet-600 shadow-xl shadow-indigo-500/25 p-5 text-white relative overflow-hidden">
			...
			<div class="relative z-10">
				<div class="flex items-start justify-between mb-4">
					...
					<div class="h-12 w-12 rounded-2xl bg-surface-0/20 backdrop-blur-sm flex items-center justify-center">
				...
				<div class="grid grid-cols-2 gap-4">
					<div class="bg-surface-0/10 backdrop-blur-sm rounded-2xl p-3">
		...
		<section>
			...
			<div class="rounded-3xl bg-surface-0 shadow-md border border-surface-200 overflow-hidden">
						...
						<div class="flex-1 min-w-0">
							<div class="flex items-center gap-2">
								...
								{#if member.role === 'admin'}
									<span class="text-[10px] font-bold bg-surface-100 text-slate-600 px-1.5 py-0.5 rounded">Admin</span>
								{/if}
							</div>
				...
				<div class="p-3 bg-surface-50 border-t border-slate-100">
					<button type="button" class="w-full h-10 rounded-xl border-2 border-dashed border-slate-300 text-text-secondary font-bold text-sm flex items-center justify-center gap-2 hover:border-indigo-300 hover:text-indigo-600 hover:bg-indigo-50 transition-all active:scale-[0.99]">
		...
		<section class="rounded-3xl bg-gradient-to-br from-amber-50 to-orange-50 border border-amber-200 p-4">
			<div class="flex items-start gap-3">
				<div class="h-10 w-10 rounded-2xl bg-surface-0/80 border border-amber-200 flex items-center justify-center shadow-sm">
