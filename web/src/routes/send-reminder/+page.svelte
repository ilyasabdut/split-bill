	...
	<main class="flex-1 overflow-y-auto px-4 py-4 space-y-5 max-w-lg mx-auto w-full" style="padding-bottom: calc(env(safe-area-inset-bottom, 0px) + 2rem);">
		...
		{:else}
			...
			<section>
				...
				<div class="rounded-3xl bg-surface-0 shadow-md border border-surface-200 p-4">
					<textarea
						...
						rows="3"
						class="w-full bg-transparent border-none p-0 text-sm text-text-primary focus:ring-0 placeholder:text-slate-300 resize-none"
					></textarea>
				</div>
			</section>
			...
			<section class="rounded-3xl bg-gradient-to-br from-slate-800 to-slate-900 p-4 text-white">
				...
				<div class="bg-surface-0/10 backdrop-blur-sm rounded-2xl p-4 text-sm">
